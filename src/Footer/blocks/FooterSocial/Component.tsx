...
import type { FooterSocialBlock as FooterSocialBlockType, SiteSetting } from '@/payload-types'

type Props = FooterSocialBlockType & {
...
export const FooterSocialBlock: React.FC<Props> = ({ title, siteSettings }) => {
